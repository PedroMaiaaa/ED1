...
int main()
{
    ...
    cout << "A media dos contatos: " << mediaIdade << endl;
    
    cout << "Nome dos contatos com a idade maior que a media " << endl;
	...
	cout << "A quantidade dos contatos maiores de idade: " << qtdMaioresIdade << endl;
